...
X_train, X_test, Y_train, Y_test = train_test_split(news['TITLE'], 
                                    news['CATEGORY'], test_size=0.2, random_state=3)
# Code ends here
...
# display accuracies
print('Naive Bayes with CountVectorizer: ',acc_count_nb)
print('Naive Bayes with Tf-idf: ',acc_tfidf_nb)
# Code ends here
...
# display accuracies
print('Logistic Regression with CountVectorizer: ',acc_count_logreg)
print('LogisticRegression with Tf-idf: ',acc_tfidf_logreg)
# Code ends here
